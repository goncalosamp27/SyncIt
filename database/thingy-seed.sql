...
VALUES 
    ('anonymous', 'Anonymous User', 'anonymousemail@example.com', 'anonymous123', 'anonymous', 'url', 'Active'),
    ('salsadancer', 'Salsa Dance Lover', 'salsadancer@example.com', 'salsadancer123', 'Salsa moves are life!', 'url', 'Active'),
    ('techbeat', 'Tech Beat DJ', 'techbeat@example.com', 'technosecure99', 'Living for the beats', 'url', 'Active'),
    ('folksinger', 'Folk Music Singer', 'folksinger@example.com', 'folkpass1234', 'Folk music and stories', 'url', 'Active'),
    ('classycat', 'Classy Cat Lover', 'classycat@example.com', 'classicalmusic', 'Classical music enthusiast', 'url', 'Active'),
    ('punkrocker', 'Punk Rock Musician', 'punkrocker@example.com', 'punkrockerpass', 'Punk rock till I die', 'url','Active'),
    ('djnight', 'DJ Night Vibes', 'djnight@example.com', 'djnight1234', 'Nightlife DJ and mixer', 'url', 'Active'),
    ('reggae_vibes', 'Reggae Music Vibes', 'reggaevibes@example.com', 'reggaepass2023', 'Feeling those reggae vibes', 'url', 'Active'),
    ('swingstar', 'Swing Dance Star', 'swingstar@example.com', 'swingpass2023', 'Swing dance for life', 'url', 'Active'),
    ('drumfiend', 'Drum Music Fiend', 'drumfiend@example.com', 'drumfiend2023', 'Percussion and rhythm addict', 'url', 'Active'),
    ('violin_virtuoso', 'Violin Virtuoso Master', 'violin@example.com', 'violinpass2023', 'Classical violinist', 'url', 'Active'),
    ('bassplayer', 'Bass Guitar Player', 'bassplayer@example.com', 'basssecure2023', 'Grooving on the bass', 'url', 'Active'),
    ('hiphop_dancer', 'Hip Hop Dance Artist', 'hiphopdancer@example.com', 'hiphoppass2023', 'Dance battles and moves', 'url', 'Active'),
    ('metalhead', 'Heavy Metal Head', 'metalhead@example.com', 'metalhead1234', 'Heavy metal all the way', 'url', 'Active'),
    ('jazzcat', 'Jazz Music Cat', 'jazzcat@example.com', 'jazzsecure2023', 'Smooth jazz, all day', 'url', 'Active'),
    ('popqueen', 'Pop Music Queen', 'popqueen@example.com', 'popdivapass2023', 'Pop music enthusiast', 'url', 'Active'),
    ('raveking', 'Rave Music King', 'raveking@example.com', 'raveking2023', 'Lover of electronic music', 'url', 'Active'),
    ('bluesfan', 'Blues Music Fan', 'bluesfan@example.com', 'bluesfan2023', 'Appreciating the blues', 'url', 'Active'),
    ('latinlover', 'Latin Dance Lover', 'latinlover@example.com', 'latinloverpass', 'Latin music and dance', 'url', 'Active'),
    ('countrygal', 'Country Music Gal', 'countrygal@example.com', 'countrygal2023', 'Country music is my soul', 'url', 'Active'),
    ('funkfiend', 'Funk Music Fiend', 'funkfiend@example.com', 'funkfiend2023', 'Funk and groove lover', 'url', 'Active'),
    ('jazzman', 'Jazz Music Man', 'jazzman@example.com', 'jazzman2023', 'Living for jazz sounds', 'url', 'Active'),
    ('rocknroller', 'Rock and Roll Player', 'rocknroller@example.com', 'rocknroller2023', 'Rock and roll fanatic', 'url', 'Active'),
    ('dancerpro', 'Professional Dancer', 'dancerpro@example.com', 'dancepro2023', 'Professional dancer', 'url', 'Active'),
    ('synthwave', 'Synth Wave Music', 'synthwave@example.com', 'synthwave2023', 'Synthwave music lover', 'url', 'Active'),
    ('guitarhero', 'Guitar Hero Player', 'guitarhero@example.com', 'guitarhero2023', 'Guitar is life!', 'url', 'Active'),
    ('soulbrother', 'Soul Brother Music', 'soulbrother@example.com', 'soulbrother2023', 'Smooth soul sounds', 'url', 'Active'),
    ('classicrocker', 'Classic Rock Musician', 'classicrocker@example.com', 'classicrocker2023', 'Classic rock fan', 'url', 'Active'),
    ('rnbvibes', 'RnB Music Vibes', 'rnbvibes@example.com', 'rnbvibes2023', 'RnB enthusiast', 'url', 'Active'),
    ('saxplayer', 'Saxophone Player', 'saxplayer@example.com', 'saxplayer2023', 'Jazz and blues saxophonist', 'url', 'Active'),
    ('bollywoodstar', 'Bollywood Dance Star', 'bollywoodstar@example.com', 'bollywoodstar2023', 'Bollywood dance lover', 'url', 'Active'),
    ('flamenco_queen', 'Flamenco Dance Queen', 'flamencoqueen@example.com', 'flamencoqueen2023', 'Passionate about Flamenco', 'url', 'Active'),
    ('edmlover', 'EDM Music Lover', 'edmlover@example.com', 'edmlover2023', 'EDM events enthusiast', 'url', 'Active'),
    ('thecomposer', 'The Music Composer', 'composer@example.com', 'thecomposer2023', 'Classical and orchestral music', 'url', 'Active'),
    ('urbanvibes', 'Urban Dance Vibes', 'urbanvibes@example.com', 'urbanvibes2023', 'Love for urban dance styles', 'url', 'Active'),
    ('tapdancepro', 'Tap Dance Professional', 'tapdancepro@example.com', 'tapdancepro2023', 'Tap dance artist', 'url', 'Active'),
    ('mambo_king', 'Mambo Dance King', 'mamboking@example.com', 'mambo_king2023', 'Mambo and Latin music fan', 'url', 'Active'),
    ('brassblues', 'Brass Blues Music', 'brassblues@example.com', 'brassblues2023', 'Brass instrument lover', 'url', 'Active'),
    ('loungecat', 'Lounge Music Cat', 'loungecat@example.com', 'loungecat2023', 'Lounge and chill music', 'url', 'Active'),
    ('folkdancer', 'Folk Dance Artist', 'folkdancer@example.com', 'folkdancer2023', 'Traditional folk dance', 'url', 'Active'),
    ('countryboy', 'Country Music Boy', 'countryboy@example.com', 'countryboy2023', 'Country music fan', 'url', 'Active'),
    ('balletlover', 'Ballet Dance Lover', 'balletlover@example.com', 'balletlover2023', 'Ballet enthusiast', 'url', 'Active'),
    ('drumbeats', 'Drum Beats Artist', 'drumbeats@example.com', 'drumbeats2023', 'Drumming and rhythm', 'url', 'Active'),
    ('gospelgal', 'Gospel Music Gal', 'gospelgal@example.com', 'gospelgal2023', 'Gospel music lover', 'url', 'Active'),
    ('discofever', 'Disco Music Fever', 'discofever@example.com', 'discofever2023', 'Disco music is life', 'url', 'Active'),
    ('pianistpro', 'Professional Pianist', 'pianistpro@example.com', 'pianistpro2023', 'Professional pianist', 'url', 'Active'),
    ('soulqueen', 'Soul Music Queen', 'soulqueen@example.com', 'soulqueen2023', 'Soul music lover', 'url', 'Active'),
    ('salsaqueen', 'Salsa Dance Queen', 'salsaqueen@example.com', 'salsaqueen2023', 'Queen of Salsa', 'url', 'Active'),
    ('rockgod', 'Rock God Musician', 'rockgod@example.com', 'rockgod2023', 'Rock music is in my veins', 'url', 'Active'),
    ('reggaemaster', 'Reggae Music Master', 'reggaemaster@example.com', 'reggaemaster2023', 'Roots and reggae', 'url', 'Active'),
    ('danceboss', 'Dance Choreography Boss', 'danceboss@example.com', 'danceboss2023', 'Professional choreographer', 'url', 'Active'),
    ('jazzsoul', 'Jazz and Soul Music', 'jazzsoul@example.com', 'jazzsoul2023', 'Smooth jazz and soul', 'url', 'Active'),
    ('trumpetstar', 'Trumpet Music Star', 'trumpetstar@example.com', 'trumpetstar2023', 'Trumpet player', 'url', 'Active'),
    ('alternativefan', 'Alternative Music Fan', 'alternativefan@example.com', 'alternativefan2023', 'Lover of alternative genres', 'url', 'Active'),
    ('indiefolk', 'Indie Folk Musician', 'indiefolk@example.com', 'indiefolk2023', 'Indie folk artist', 'url', 'Active'),
    ('tangodancer', 'Tango Dance Lover', 'tangodancer@example.com', 'tangodancer2023', 'Passionate about Tango', 'url', 'Active'),
    ('edmstar', 'EDM Star Artist', 'edmstar@example.com', 'edmstar2023', 'EDM superstar', 'url', 'Active'),
    ('acousticfan', 'Acoustic Music Fan', 'acousticfan@example.com', 'acousticfan2023', 'Acoustic music only', 'url', 'Active'),
    ('latindiva', 'Latin Diva Singer', 'latindiva@example.com', 'latindiva2023', 'Latin music is life', 'url', 'Active'),
    ('swingmaster', 'Swing Master Dancer', 'swingmaster@example.com', 'swingmaster2023', 'Swing dance enthusiast', 'url', 'Active'),
    ('classicpiano', 'Classical Piano Artist', 'classicpiano@example.com', 'classicpiano2023', 'Classical piano lover', 'url', 'Active'),
    ('dubstepking', 'Dubstep King Artist', 'dubstepking@example.com', 'dubstepking2023', 'Dubstep and drops', 'url', 'Active'),
    ('bluesmaster', 'Blues Music Master', 'bluesmaster@example.com', 'bluesmaster2023', 'Blues all the way', 'url', 'Active'),
    ('latinbeats', 'Latin Beats Music', 'latinbeats@example.com', 'latinbeats2023', 'Dancing to Latin beats', 'url', 'Active'),
    ('moondancer', 'Moon Dance Artist', 'moondancer@example.com', 'moondancer2023', 'Dancing under the stars', 'url', 'Active'),
    ('trapmaster', 'Trap Music Master', 'trapmaster@example.com', 'trapmaster2023', 'Trap music and vibes', 'url', 'Active'),
    ('folkmagic', 'Folk Music Magic', 'folkmagic@example.com', 'folkmagic2023', 'Folk traditions', 'url', 'Active'),
    ('electricblues', 'Electric Blues Music', 'electricblues@example.com', 'electricblues2023', 'Electric blues lover', 'url', 'Active'),
    ('afrobeatking', 'Afrobeat King Music', 'afrobeatking@example.com', 'afrobeatking2023', 'Afrobeat vibes', 'url', 'Active'),
    ('bassqueen', 'Bass Queen Music', 'bassqueen@example.com', 'bassqueen2023', 'Bass guitar and groove', 'url', 'Active'),
    ('electrovibe', 'Electro Vibe Music', 'electrovibe@example.com', 'electrovibe2023', 'Electro sounds', 'url', 'Active'),
    ('raggagirl', 'Ragga Girl Artist', 'raggagirl@example.com', 'raggagirl2023', 'Ragga and reggae vibes', 'url', 'Active'),
    ('discoqueen', 'Disco Queen Dancer', 'discoqueen@example.com', 'discoqueen2023', 'Disco diva', 'url', 'Active'),
    ('latinoheat', 'Latino Heat Music', 'latinoheat@example.com', 'latinoheat2023', 'Latin music and dance', 'url', 'Active'),
    ('afrojazz', 'Afro Jazz Music', 'afrojazz@example.com', 'afrojazz2023', 'Afro Jazz fusion', 'url', 'Active'),
    ('kpopfan', 'KPop Music Fan', 'kpopfan@example.com', 'kpopfan2023', 'K-Pop for life', 'url', 'Active'),
    ('bollydance', 'Bolly Dance Artist', 'bollydance@example.com', 'bollydance2023', 'Bollywood dance styles', 'url', 'Active');
...
VALUES 
    ...
    ('Classical', 'DAF7A6'),     -- Light Green for Classical
    ('Electronic', 'C70039'),    -- Red for Electronic
    ('HipHop', '581845'),        -- Dark Purple for Hip Hop
    ('Metal', '8B0000'),         -- Dark Red for Metal
    ('Reggae', 'FF5733'),        -- Orange for Reggae
    ('Latin', 'FF33FF'),         -- Magenta for Latin
    ('Pop', 'FF69B4'),           -- Hot Pink for Pop
    ('Blues', '1C1C1C'),         -- Black for Blues
    ('Soul', 'FFD700'),          -- Gold for Soul
    ('Indie', 'A569BD'),         -- Purple for Indie
    ('Folk', 'FF4500'),          -- Orange Red for Folk
    ('Psytrance', '00CED1'),     -- Dark Turquoise for Psytrance
    ('NeoSoul', '6A5ACD'),       -- Slate Blue for Neo Soul
    ('Country', 'B8860B'),       -- Dark Goldenrod for Country
    ('Afrobeat', 'FF7F50'),      -- Coral for Afrobeat
    ('LoFi', '778899'),          -- Light Slate Gray for Lo-Fi
    ('EDM', '00FF7F'),           -- Spring Green for EDM
    ('Dubstep', '4B0082'),       -- Indigo for Dubstep
    -- Dance Styles
    ('Salsa', 'FF6347'),         -- Tomato for Salsa
    ('Ballet', 'F08080'),        -- Light Coral for Ballet
    ('Tango', 'DC143C'),         -- Crimson for Tango
    ('HipHopDance', 'FF4500'),   -- Orange Red for Hip Hop Dance
    ('Ballroom', '8A2BE2'),      -- Blue Violet for Ballroom
    ('Contemporary', '20B2AA'),  -- Light Sea Green for Contemporary
    ('Breakdance', '4682B4'),    -- Steel Blue for Breakdance
    ('SwingDance', '5F9EA0'),    -- Cadet Blue for Swing Dance
    ('TapDance', '8B4513'),      -- Saddle Brown for Tap Dance
    ('Flamenco', 'FF1493'),      -- Deep Pink for Flamenco
    ('Zumba', 'ADFF2F'),         -- Green Yellow for Zumba
    ('Bollywood', 'FF7F50'),     -- Coral for Bollywood Dance
    ('JazzDance', 'FFD700'),     -- Gold for Jazz Dance
    ('Waltz', 'B0E0E6'),         -- Powder Blue for Waltz
    ('Samba', 'FF4500'),         -- Orange Red for Samba
    ('AfroCuban', 'FF6347'),     -- Tomato for Afro-Cuban
    ('StreetDance', '2E8B57'),   -- Sea Green for Street Dance
    ('LatinDance', 'FF69B4'),    -- Hot Pink for Latin Dance
    ('Foxtrot', 'CD5C5C'),       -- Indian Red for Foxtrot
    ('Quickstep', '20B2AA'),     -- Light Sea Green for Quickstep
    -- Event Settings
    ('Outdoors', '228B22'),      -- Forest Green for Outdoor events
    ('Indoors', '808080'),       -- Gray for Indoor events
    ('Beach', '87CEEB'),         -- Sky Blue for Beach events
    ('Garden', '32CD32'),        -- Lime Green for Garden events
    ('Park', '98FB98'),          -- Pale Green for Park settings
    ('Lounge', 'D2B48C'),        -- Tan for Lounge settings
    ('Rooftop', '4682B4'),       -- Steel Blue for Rooftop events
    ('Club', '000000'),          -- Black for Club settings
    ('Amphitheater', 'A9A9A9'),  -- Dark Gray for Amphitheater
    ('Barn', '8B4513'),          -- Saddle Brown for Barn settings
    ('Arena', '2F4F4F'),         -- Dark Slate Gray for Arena events
    ('Hall', '778899'),          -- Light Slate Gray for Hall settings
    ('Studio', 'B0C4DE'),        -- Light Steel Blue for Studio events
    ('Festival', 'FFD700'),      -- Gold for Festival-type events
    ('Ballroom', 'DDA0DD'),      -- Plum for Ballroom settings
    ('Theater', '9370DB'),       -- Medium Purple for Theater
    -- Event Moods
    ('Energetic', 'FF4500'),     -- Orange Red for energetic events
    ('Relaxed', '87CEFA'),       -- Light Sky Blue for relaxed events
    ('Romantic', 'FF69B4'),      -- Hot Pink for romantic events
    ('Mellow', 'BC8F8F'),        -- Rosy Brown for mellow events
    ('Vibrant', 'FF6347'),       -- Tomato for vibrant events
    ('Intimate', '6A5ACD'),      -- Slate Blue for intimate events
    ('HighEnergy', '00CED1'),    -- Dark Turquoise for high-energy events
    ('Sophisticated', 'B0E0E6'), -- Powder Blue for sophisticated events
    ('Party', 'FF1493'),         -- Deep Pink for party mood
    ('Chill', '708090'),         -- Slate Gray for chill events
    ('Cultural', 'FFDEAD'),      -- Navajo White for cultural events
    ('Nostalgic', 'DAA520'),     -- Goldenrod for nostalgic events
    ('Exotic', 'D2691E');        -- Chocolate for exotic events
